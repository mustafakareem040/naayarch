    ...
    return (
        <>
            <div className="flex items-center mb-6">
                ...
                <h1 className="text-3xl -z-10 text-[#181717] left-0 right-0 absolute font-sans text-center font-bold">My
                    Order Detail</h1>
            </div>
...
const OrderTrackingStep = ({ label, date, isCompleted, isLast }) => (
    <div className="flex items-center">
        <div className="relative">
            <div className={`w-8 h-8 rounded-full border-2 ${isCompleted ? 'bg-green-500 border-green-500' : 'bg-white border-gray-300'} flex items-center justify-center`}>
                {isCompleted && (
...
const ProductItem = ({ image, name, details, price }) => (
    <div className="flex font-sans w-full items-start space-x-4 bg-white rounded-lg shadow-sm mb-4">
        ...
        <div className="flex-grow space-y-3">
            ...
            {details.map((detail, index) => (
                ...
                <div className="bg-gray-100 w-fit px-3 py-1 rounded-md">
                    <span className="text-sm">Qty:1</span>
                    <span className="ml-1">▼</span>
                </div>
                <p className="">{price} IQD</p>
        </div>
    </div>
);
...
const OrderedProducts = ({products}) => (
    <>
        <h2 className="text-2xl font-bold mb-4">Ordered Product</h2>
