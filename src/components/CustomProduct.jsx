...
const CustomProduct = ({ title, subtitle, description, bigimg = "/face.png", flower, hideFlower }) => {
    return (
        <div className="white rounded-lg p-4 mb-12">
            <p className="text-center font-sans text-2xl md:text-3xl lg:text-[3em]">{title}</p>
            {!hideFlower && flower && (
            ...
            <div
                ...
                <div
                    ...
                    <p className="inline font-sans mb-7 text-2xl md:text-3xl lg:text-4xl">{subtitle}</p>
