...
const SearchComponent = ({ onSearch }) => {
    ...
    const debouncedSearch = useCallback(debounce((value) => {onSearch(value);}, 300),
        [onSearch]
    );
            ...
            <AnimatePresence>
                {filter && (
                    ...
                    >
                        ...
                        >
            {filter ? <FilterComponent modalRef={modalRef} onFilter={() => {}} filter={filter} setFilter={setFilter} /> : <></>}
                    </motion.div>
                </motion.div>)}
                    </AnimatePresence>
