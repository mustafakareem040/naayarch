...
const ProductItem = ({ title, price, imageUrl }) => {
    return (
        <div className="bg-white aspect-[2/3] relative flex flex-col w-full drop-shadow overflow-hidden group">
            ...
            <div className="absolute min-h-[104px] bottom-0 left-0 right-0 bg-gradient-custom rounded-t-lg p-2 flex flex-col justify-end">
                <h3 className="font-sans font-medium text-xs sm:text-sm leading-tight tracking-tight text-[#181717] mb-auto">
                    {title}
                </h3>
